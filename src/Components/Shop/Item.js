...
function Item(props) {
  ...
  let [Itemlength, setItemlength] = useState(Features.items ? Features.items.length : null);
    ...
    <div className="main">
      ...
      <div className="arrow-back-div">
        ...
        <div className="item-info"> 
            ...
            <img
            src={Search.images.icon !== null ? Search.images.icon : Search.images.smallIcon}
      ...
      <div className="search-item-div">
        ...
        <div className="search-info-main">
          ...
          <p> Introduction: {Search.introduction ? Search.introduction.text : "Introduction date not available"} </p>
        ...
        <h3> Shop History </h3>
        {Search.shopHistory === null ? <p> No history found </p> : Search.shopHistory.map((date, index) => 
          <p key={index} className="date-shophistory">  {dateFormat(date, "mmmm dS, yyyy")} </p>
        )}
      ...
      <div className="item-price">
        ...
        <img src={VBucks} className="v-bucks-img-item" alt="v-bucks price" />
      </div>
